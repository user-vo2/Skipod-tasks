...
\begin{verbatim}
eugene@eugene:~/Skipod/Skipod2$ ./raymond.sh
0 acquared the marker from 0, entering critical section.
0 exiting critical section
2 acquared the marker from 0, entering critical section.
2 exiting critical section
6 acquared the marker from 2, entering critical section.
6 exiting critical section
14 acquared the marker from 6, entering critical section.
14 exiting critical section
14 finished
13 acquared the marker from 6, entering critical section.
13 exiting critical section
13 finished
6 finished
5 acquared the marker from 2, entering critical section.
5 exiting critical section
11 acquared the marker from 5, entering critical section.
11 exiting critical section
24 acquared the marker from 11, entering critical section.
24 exiting critical section
24 finished
23 acquared the marker from 11, entering critical section.
23 exiting critical section
23 finished
11 finished
12 acquared the marker from 5, entering critical section.
12 exiting critical section
12 finished
5 finished
2 finished
0 finished
1 acquared the marker from 0, entering critical section.
1 exiting critical section
4 acquared the marker from 1, entering critical section.
4 exiting critical section
9 acquared the marker from 4, entering critical section.
9 exiting critical section
20 acquared the marker from 9, entering critical section.
20 exiting critical section
20 finished
19 acquared the marker from 9, entering critical section.
19 exiting critical section
19 finished
9 finished
10 acquared the marker from 4, entering critical section.
10 exiting critical section
21 acquared the marker from 10, entering critical section.
21 exiting critical section
21 finished
22 acquared the marker from 10, entering critical section.
22 exiting critical section
22 finished
10 finished
4 finished
1 finished
3 acquared the marker from 1, entering critical section.
3 exiting critical section
8 acquared the marker from 3, entering critical section.
8 exiting critical section
17 acquared the marker from 8, entering critical section.
17 exiting critical section
17 finished
18 acquared the marker from 8, entering critical section.
18 exiting critical section
18 finished
8 finished
3 finished
7 acquared the marker from 3, entering critical section.
7 exiting critical section
15 acquared the marker from 7, entering critical section.
15 exiting critical section
15 finished
7 finished
16 acquared the marker from 7, entering critical section.
